    ...
    <main className="article-page">
      ...
      <article>
        ...
        <div className="report-body">
          ...
          <section><h2>5．日銀会合最終日―午前7時時点では結果未公表</h2><p>日本銀行は9月17〜18日に金融政策決定会合を開催している。日銀の公式リリース予定では18日の「Statement on Monetary Policy」は時刻未定で、午前7時時点では公表されていない。直前の政策方針は無担保コール翌日物を1.0%程度に誘導するもので、市場では追加利上げへの警戒が強いが、本記事では未公表の決定内容を推測して記載しない。国内政策では高市政権が17日に主要経済閣僚を留任させ、成長投資と積極財政を加速する姿勢を示した。</p><p className="inline-sources"><a href="https://www.boj.or.jp/en/" target="_blank" rel="noreferrer">日本銀行（2026年9月18日確認）</a> <a href="https://www.boj.or.jp/en/about/calendar/index.htm" target="_blank" rel="noreferrer">日本銀行・公表予定（2026年9月18日確認）</a> <a href="https://www.reuters.com/world/asia-pacific/japans-takaichi-set-signal-policy-continuity-cabinet-reshuffle-2026-09-16/" target="_blank" rel="noreferrer">Reuters（2026年9月17日）</a></p><h3>市場への影響</h3><p>日銀の政策金利だけでなく、植田総裁が中立金利や今後の利上げペースをどう説明するかが円・銀行株・長期国債の方向を左右する。積極財政と金融引き締めが同時進行すれば、日本の長期金利には上昇圧力が残りやすい。</p><h3>次の注目点</h3><ul><li>日銀の政策決定、採決内容、植田総裁会見</li><li>円相場と10年・30年国債利回りの反応</li></ul></section>
